...
namespace SolarTimeProvider.Services
{
    public class SolarCalculator
    {
        ...
        private static TimeSpan CalculateSolarTimeOffset(Location location, DateTimeOffset instant, double zenith, bool isSunrise)
        {
            ...
            sunLocalHoursCos = Math.Max(-1, Math.Min(1, sunLocalHoursCos));
